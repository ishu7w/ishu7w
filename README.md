...
<details>
<summary>Numbers, sources & scope · updated 2026-09-20</summary>

- **14** public repositories, including forks.
- **0** stars across public, non-fork repositories (¹).
- **2** followers.
- **11** merged public pull requests outside my own repositories (²).
...
- **[Gson](https://github.com/google/gson/pull/3115)** — Avoid quadratic removeIf behavior in JsonArray list views. *Merged.*
- **[Java Pathfinder](https://github.com/javapathfinder/jpf-core/pull/641)** — Fix position clamping when a buffer limit changes. *Merged.*
